...
<template>
  ...
  <section v-if="showHomePage" class="flex flex-col h-screen dark:bg-[#121212]">
    <div class="flex justify-end margin mt-3 mr-5"><input type="checkbox" class="toggle" @click="toggleDark()"/></div>
    <div class="max-w-screen-lg mx-auto my-4 flex flex-col gap-20 items-center justify-center h-screen px-4 md:flex-row">
      <div class="flex flex-col justify-center">
        <h1 class="text-2xl sm:text-7xl font-bold text-white dark:text-white">Simon Says</h1>
